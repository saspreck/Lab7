...
public class PatientsTest {
	...
	public void HealthyPersonTest(){
		...
		Assert.assertEquals("Incorrect toString", "Skyler, a 18-year old person. In for Check-up.", hp1.toString());
	...
	public void SickPersonTest() {
		...
		Assert.assertEquals("Incorrect toString", "John, a 35-year old person. Severity level 2.", sp1.toString());
